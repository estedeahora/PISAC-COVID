    ...
    tabPanel("Proyecto", icon = icon("question"),
             sidebarLayout(
               ...
               mainPanel(width = 6,
                 ...
                 h2("Cómo citar..."),
                 HTML("Serrati, P. (2021). <em> Aplicaci&oacute;n TRIP-COVID </em> (v0.9.0-beta) [Aplicaci&oacute;n Shiny]. Proyecto PISAC TRIP-COVID. <a href='https://doi.org/10.5281/zenodo.6496390'>https://doi.org/10.5281/zenodo.6496390</a>"),
                 HTML("<br> <br>
                    <p>Versi&oacute;n online: <a href='https://trip-pisac.shinyapps.io/COVID/'>https://trip-pisac.shinyapps.io/COVID/</a></p>  
